...
| #2 | Git and Github  |    |    |
| #3 | SQL basics |    |    |
| #4 | Introduction to Julia |  [Notes](https://juliadatascience.io/julia_basics) | More in depth [notes](https://juliateachingctu.github.io/Julia-for-Optimization-and-Learning/stable/). For Python read these [notes](https://datascience.quantecon.org/python_fundamentals/index.html)   |
