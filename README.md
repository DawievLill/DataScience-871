...
| #2 | Git and Github  |    |    |
| #3 | SQL basics |    |    |
| #4 | Introduction to Julia |  [Notes](https://juliadatascience.io/julia_basics) | Also read QE Python [notes](https://datascience.quantecon.org/python_fundamentals/index.html)   |
