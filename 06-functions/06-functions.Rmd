...
The primary references for today's discussion can be found [here](https://stat545.com/functions-part1.html) and  [here](https://style.tidyverse.org/functions.html).
...
pacman::p_load(pbapply, data.table, tidyverse, gapminder, assertthat)
```
